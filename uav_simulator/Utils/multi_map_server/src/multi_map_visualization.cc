...
int main(int argc, char** argv)
{
  ...
  auto sub1 = n->create_subscription<MMSG>("dmaps2d", 1, maps2d_callback);
  auto sub2 = n->create_subscription<MMSG>("dmaps3d", 1, maps3d_callback);
  pub1 = n->create_publisher<multi_map_server::msg::MultiOccupancyGrid>("maps2d", 1, true);
  pub2 = n->create_publisher<sensor_msgs::msg::PointCloud>("map3d", 1, true);
