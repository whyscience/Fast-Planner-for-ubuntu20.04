...
int main(int argc, char** argv)
{
  ...
  auto sub1 = n->create_subscription<multi_map_server::msg::MultiOccupancyGrid>("dmaps2d", 1, maps2d_callback);
  auto sub2 = n->create_subscription<multi_map_server::msg::MultiSparseMap3D>("dmaps3d", 1, maps3d_callback);
  pub1 = n->create_publisher<multi_map_server::msg::MultiOccupancyGrid>("maps2d", 1);
